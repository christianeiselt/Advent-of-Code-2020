...
Readonly my $SOLUTION_PART_ONE => AOC2020::Day04->get_valid_count_part_one($PUZZLE_INPUT_REF);
Readonly my $SOLUTION_PART_TWO => AOC2020::Day04->get_valid_count_part_two($PUZZLE_INPUT_REF);
