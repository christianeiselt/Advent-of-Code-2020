...
Readonly my $SOLUTION_PART_ONE =>
    AdventOfCode::Day01->get_product_of_numbers_adding_to( $TARGET_SUM, $PUZZLE_INPUT_REF, $NUMBER_COUNT_PART_ONE );
Readonly my $SOLUTION_PART_TWO =>
    AdventOfCode::Day01->get_product_of_numbers_adding_to( $TARGET_SUM, $PUZZLE_INPUT_REF, $NUMBER_COUNT_PART_TWO );
