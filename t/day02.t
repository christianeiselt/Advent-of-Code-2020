...
subtest 'count valid passwords for Part One' => sub {
  ...
  is( AOC2020::Day02->get_valid_password_count_for_part( 1, $example_input ),
    2, 'count 2 valid passwords' );
  is( AOC2020::Day02->get_valid_password_count_for_part( 1, $puzzle_input ),
    416, 'count 416 valid passwords' );
};
...
subtest 'count valid passwords for Part Two' => sub {
  ...
  is(
    AOC2020::Day02->get_valid_password_count_for_part( 2, $example_input ),
    1, 'count 1 valid passwords'
  );
  is( AOC2020::Day02->get_valid_password_count_for_part( 2, $puzzle_input ),
    688, 'count 688 valid passwords' );
};
