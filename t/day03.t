...
subtest 'count trees on route for Part One' => sub
{
  ...
  is(AOC2020::Day03->GetTreeCountForSlope($input, $slopes->{'slopeB'}, $startPos),7,'correct count');
};
...
subtest 'count trees on routes for Part Two' => sub
{
  ...
  is(AOC2020::Day03->GetProductOfTreeCounts($input, $slopes, $startPos),336,'correct product for example');
};
